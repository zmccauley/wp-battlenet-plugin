...
function display_affixes($result,$my_creds){
  ...
  foreach ($result['affixes'] as $index => $affix) {
    ...
    $affixes_formatted .= "<div style='display:block;' class='hover-target' data-text='" . $affix_description['description'] . "'>" . $affix['name'] . "</div>" . "<div class='hover-text' id='hoverText'></div>\n";
