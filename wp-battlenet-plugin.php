...
function blizzard_call_func() {
  ...
  return "<h1>The present value of a WoW token is {$gold_value} gold</h1><p> via the <a href='https://develop.battle.net/documentation/world-of-warcraft/game-data-apis'>Blizzard API</a></p>";
}
